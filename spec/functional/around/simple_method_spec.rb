...
describe AOP do
  ...
  context 'simple, method based, around aspect' do 
    before do
      class_under_test.new_method :main do |a| @a += a end
      class_under_test.new_method :around do |concern, a|
        @a = 0
        concern.( a )
        @a += 1
      end
      class_under_test.around :main, :around
    end
    ...
    context 'aspects store results of concerns correctly' do 
      ...
      before do
        ...
        class_under_test.new_method :around_a do |concern|
          capt.before
          concern.()
          capt.after
        end
        class_under_test.around %r{\Aa\d}, :around_a
  ...
  end # context 'simple, method based, around aspect'
